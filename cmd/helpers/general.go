...
// NormalizeArmorFlags facilitates transitions to Armor command-line flags,
// e.g. --vaultCaCert to --vaultCACert
func NormalizeArmorFlags(f *pflag.FlagSet, name string) pflag.NormalizedName {
	switch name {
	case "vaultCaCert":
		name = "vaultCACert"
		break
